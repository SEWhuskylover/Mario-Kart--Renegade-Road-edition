...
msg_font = pygame.font.SysFont("timesnewroman", 20)
...
def message(msg, txt_colour, bkgd_colour):
    ...
    # Centre rectangle
    text_box = txt.get_rect(center=(display_width / 2, display_height / 2))
...
while not exiting:
    ...
    while game_over:
        ...
        message("         YOU DIED"
                ...
                " ESC for quit, SPACE for again", RED, BLACK)  # death message
